...
export const Mic: React.FC<IconProps> = ({ color = "white" }) => {
  return (
    <svg
      width="24"
      height="24"
...
export const TextVoice: React.FC<IconProps> = ({ color = "white" }) => {
  return (
    <svg
      width="24"
      height="24"
...
export const Pdf: React.FC<IconProps> = ({ color = "white" }) => {
  return (
    <svg
      width="24"
      height="24"
